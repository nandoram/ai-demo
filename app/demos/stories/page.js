...
export default function KidStories({}) {
  ...
  const handleButtonPress = async () => {
    ...
    if (name.length > 20)
      return setError('Name must be less than 20 characters')
    if (lesson.length > 100)
      return setError('Lesson must be less than 100 characters')
    setError('')
  ...
  return (
    <Stack p={20} pt={30} bg="$gray1" ai="center" flex={1}>
      ...
      <Paragraph mb={40} col="$gray9" ta="center">
        Generate a custom, short and teachable story for your little ones,
      ...
      <YStack
        ...
        bw={1}
      >
        <H3 fow="100" mt={20} fos={39}>
          What is the child&apos;s name?
        </H3>
        <YStack space={0}>
          <Label fow="100" col={'$gray9'} htmlFor="name">
            First Name:{' '}
          </Label>
          <Input
            w="100%"
        ...
        >
          ...
          >
            ...
            <Label fos={20} fow={300} col={'$pink9'}>
              👧 Girl biased story
            </Label>
          </XStack>
          <XStack
          ...
          >
            ...
            <Label fos={20} fow={300} col={'$blue9'}>
              👦 Boy biased story
            </Label>
          </XStack>
          <XStack
        ...
        <Label fow="900" fos={55} lineHeight={18} mt={20} htmlFor="age">
          {age}
        </Label>
        <Label
          fow="100"
        ...
        <Separator alignSelf="stretch" my={20} />
        <H3 fow="100" mb={10} fos={39}>
          Select story category
        </H3>
        <Select
          native={media.xs ? true : false}
          size={'$6'}
        ...
        <YStack space={0} mb={20}>
          <Label fow="100" col={'$gray9'} htmlFor="name">
            eg. why playing on the road is dangerous{' '}
          </Label>
          <Input
            w="100%"
            fow="600"
        ...
        {error && (
          <Paragraph mt={20} col="$red9" ta="center">
            {error}
          </Paragraph>
        )}
        ...
        <Button
          ...
          fow="900"
          theme="fire"
          bg={story.length > 0 ? '$gray8' : '$purple6'}
        >
          {loading && <Spinner />} {loading ? 'Generating...' : 'CREATE STORY'}
        </Button>
        <Button
          chromeless
          onPress={() => router.push('/demos/stories/view-all')}
        >
          View all
        </Button>
      </YStack>
      {story && (
        ...
        >
          ...
          <Paragraph fow="100" fos={16} lh={32}>
            {story}
          </Paragraph>
        </YStack>
      )}
